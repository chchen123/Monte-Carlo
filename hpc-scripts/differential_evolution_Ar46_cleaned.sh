...
#This script calls for differential evolution fitting python script which fits cleaned data
...
OUTPUT_DIR="/mnt/research/attpc/data/e15503b/DEtest/with_cleaning"
...
if [ -e $INPUT_FILE ]; then
   ...
   /mnt/home/mkuchera/external/Python-3.6.1/python ${HOME}/ATTPC/pytpc/bin/differential_evolution.py ${CONFIG_FILE} ${INPUT_FILE_TEMP} ${OUTPUT_FILE_TEMP}
